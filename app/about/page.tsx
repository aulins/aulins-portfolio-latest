                            ...
                            <div className="space-y-6">
                                ...
                                <div className="backdrop-blur-md bg-slate-900/50 border border-blue-500/20 rounded-2xl p-4 hover:border-blue-500/50 transition-all duration-300">
                                    ...
                                    <div className="aspect-video rounded-xl overflow-hidden relative group">
                                        <img src="/internship.jpeg" alt="Infrastructure internship documentation" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                                        {/* Glass Blur Overlay for Privacy */}
